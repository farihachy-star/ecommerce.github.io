                        ...
                        @foreach($cart_datas as $cart_data)
                            ...
                            <tr>
                                ...
                                <td class="cart_description">
                                    <h4><a href="">{{$cart_data->title}}</a></h4>
            ...
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <div class="total_area">
                        ...
                        <div class="btn btn-warning add_cart font-size-12"  style="margin-left: 20px;"><a style="color: black !important;" href="{{url('/check-out')}}">Check Out</a></div>
                    </div>
                </div>
            </div>
        </div>
