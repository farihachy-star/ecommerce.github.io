...
<head>
  ...
  <title>Admin - Form Advanceds</title>
      ...
      <li class="nav-item active">
        ...
        <div id="collapseForm" class="collapse show" aria-labelledby="headingForm" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="{{Route('admin.formbasic')}}">Form Basics</a>
            <a class="collapse-item active" href="{{Route('admin.formadvanced')}}">Form Advanceds</a>
          </div>
        </div>
      </li>
      <li class="nav-item">
