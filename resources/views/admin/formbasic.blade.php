  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav sidebar sidebar-light accordion" id="accordionSidebar">
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="{{Route('index')}}">
        ...
        <div class="sidebar-brand-text mx-3">Go Fresh</div>
      </a>
      ...
      <li class="nav-item active">
        ...
        <div id="collapseForm" class="collapse show" aria-labelledby="headingForm"
          ...
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item  active" href="{{Route('admin.formbasic')}}">Form Basics</a>            
            <a class="collapse-item" href="{{Route('admin.formadvanced')}}">Form Advanceds</a>
          </div>
        </div>
      </li>
      <li class="nav-item">
